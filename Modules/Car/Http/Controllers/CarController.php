...
class CarController extends Controller
{
    ...
    {
        $cars = Car::with('translate','dealer')->latest()->get();
    ...
    {
        $cars = Car::with('translate','dealer')->where('approved_by_admin', 'pending')->latest()->get();
    ...
    {
        $cars = Car::with('translate','dealer')->where('is_featured', 'enable')->latest()->get();
