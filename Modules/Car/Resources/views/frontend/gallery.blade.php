@extends('layout')
@section('title')
    <title>{{ __('translate.Property Gallery') }}</title>
@endsection
    ...
    <div class="inner-banner-img" style=" background-image: url({{ asset($breadcrumb) }}) ;"></div>
        ...
        <div class="col-lg-12">
            <div class="inner-banner-df">
                <h1 class="inner-banner-taitel">{{ __('translate.Property Gallery') }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('translate.Home') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('translate.Property Gallery') }}</li>
                    </ol>
                </nav>
            </div>
            </div>
                    ...
                    <div class="row gy-5">
                        ...
                        <div class="col-lg-12">
                            <div class="car-images">
                                <h3 class="car-images-taitel">{{ __('translate.Car') }} : {{ html_decode($car->translate->title) }}</h3>
