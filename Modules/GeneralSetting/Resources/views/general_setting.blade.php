                                                                                ...
                                                                                <div class="row">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-5">
                                                                                                <div class="crancy__item-form--group mg-top-20">
                                                                                                    <label class="crancy__item-label">{{__('Header Logo')}}</label>
                                                                                                    <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                                                        ...
                                                                                                        <label class="crancy-image-video-upload__label" for="input-img1">
                                                                                                            <img class="website_logo" id="view_img" src="{{ asset($general_setting->logo) }}">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="row">
                                                                                            <div class="col-md-5">
                                                                                                <div class="crancy__item-form--group mg-top-20">
                                                                                                    <label class="crancy__item-label">{{__('Footer Logo')}}</label>
                                                                                                    <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                                                        ...
                                                                                                        <label class="crancy-image-video-upload__label" for="input-img5">
                                                                                                            <img class="website_logo" id="view_img_5" src="{{ asset($general_setting->logo_2) }}">
                                                                                                            <h4 class="crancy-image-video-upload__title">{{ __('translate.Click here to') }} <span class="crancy-primary-color">{{ __('translate.Choose File') }}</span> {{ __('translate.and upload') }} </h4>
                                                                                                        </label>
                                                                                                    </div>
                                                                                                </div>
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="row">
                                                                                            <div class="col-md-5">
                                                                                                <div class="crancy__item-form--group mg-top-20">
                                                                                                    <label class="crancy__item-label">{{__('Inner Logo')}}</label>
                                                                                                    <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                                                        ...
                                                                                                        <label class="crancy-image-video-upload__label" for="input-img50">
                                                                                                            <img class="website_logo" id="view_img_6" src="{{ asset($general_setting->inner_logo) }}">
                                                                                                            <h4 class="crancy-image-video-upload__title">{{ __('translate.Click here to') }} <span class="crancy-primary-color">{{ __('translate.Choose File') }}</span> {{ __('translate.and upload') }} </h4>
                                                                                                        </label>
                                                                                                    </div>
                                                                                                </div>
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="row">
                                                                                            <div class="col-md-5">
                                                                                                <div class="crancy__item-form--group mg-top-20">
                                                                                                    <label class="crancy__item-label">{{__('Website favicon')}}</label>
                                                                                                    <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                                                        ...
                                                                                                        <label class="crancy-image-video-upload__label" for="input-favicon">
                                                                                                            <img class="website_logo" id="view_img2" src="{{ asset($general_setting->favicon) }}">
                                                                                                            <h4 class="crancy-image-video-upload__title">{{ __('translate.Click here to') }} <span class="crancy-primary-color">{{ __('translate.Choose File') }}</span> {{ __('translate.and upload') }} </h4>
                                                                                                        </label>
                                                                                                    </div>
                                                                                                </div>
