...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Join as Dealer') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Manage Section') }} >> {{ __('translate.Join as Dealer') }}</p>
@endsection
                                    ...
                                    <div class="crancy-product-card translation_main_box">
                                        ...
                                        <div class="translation_box">
                                            <ul >
                                                ...
                                                <li><a href="{{ route('admin.join-as-dealer', ['lang_code' => $language->lang_code] ) }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <!-- Dashboard Inner -->
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.update-join-as-dealer') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="crancy__item-form--group w-100 h-100">
                                                                ...
                                                                <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                    <input type="file" class="btn-check" name="dealer_bg_image" id="input-img1" autocomplete="off" onchange="previewImage(event)">
                                                                    <label class="crancy-image-video-upload__label" for="input-img1">
                                                                        <img id="view_img" src="{{ asset($join_dealer->dealer_bg_image) }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="crancy__item-form--group w-100 h-100">
                                                                ...
                                                                <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                    <input type="file" class="btn-check" name="dealer_foreground_image" id="input-img2" autocomplete="off" onchange="previewForgroundImage(event)">
                                                                    <label class="crancy-image-video-upload__label" for="input-img2">
                                                                        <img id="view_forground_img" src="{{ asset($join_dealer->dealer_foreground_image) }}">
                                                                        <h4 class="crancy-image-video-upload__title">{{ __('translate.Click here to') }} <span class="crancy-primary-color">{{ __('translate.Choose File') }}</span> {{ __('translate.and upload') }} </h4>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="short_title" id="short_title" value="{{ $translate->dealer_short_title }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="dealer_title" id="dealer_title" value="{{ $translate->dealer_title }}">
                                                    </div>
                                                </div>
